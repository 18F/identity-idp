  ...
  plugins: [
    new WebpackAssetsManifest({
      ...
      publicPath(filename, plugin) {
        ...
        const outputPublicPath = plugin.compiler?.options.output.publicPath;
        return filename.endsWith('.js') && typeof outputPublicPath === 'string'
          ? url.resolve(outputPublicPath, filename)
          : filename;
      },
      writeToDisk: true,
