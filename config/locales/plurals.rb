...
# copied directly from https://github.com/ruby-i18n/i18n/blob/master/test/test_data/locales/plurals.rb
# test files are not included in the built gem so we can't just add that to the load path
