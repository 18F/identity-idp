  ...
  before do
    cloudwatch_client = double(
      ...
      fetch: [
        ...
        { 'user_id' => 'user6', 'gpo_verification_pending'=>'1', 'name' => 'IdV: phone of record visited' },
        ...
        { 'user_id' => 'user7', 'in_person_verification_pending'=>'1', 'name' => 'IdV: doc auth verify submitted' },
        ...
        { 'user_id' => 'user8', 'fraud_review_pending'=>'1', 'name' => 'IdV: doc auth verify submitted' },
  ...
  def expected_tables(strings: false)
    [
      ...
      [
        ...
        ['SSN (page view)'] + string_or_num(strings, 6, 1, 0.14285714285714285, 0.75),
        ['Verify Info (page view)'] + string_or_num(strings, 5, 1, 0.16666666666666666, 0.625),
