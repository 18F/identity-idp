  ...
  module Tasks
    class BaseTask
      ...
      ALLOWED_UNTRANSLATED_KEYS = [
        ...
        { key: 'doc_auth.headings.document_capture_selfie', locales: %i[es fr] }, # Translations for Selfie french are the same as English
        { key: 'doc_auth.headings.document_capture_subheader_selfie_review', locales: %i[es fr] }, # Translations for Selfie french are the same as English
