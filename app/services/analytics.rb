...
class Analytics
  ...
  PROOFING_ADDRESS_RESULT_MISSING = 'Proofing Address Result Missing'
  PROOFING_DOCUMENT_RESULT_MISSING = 'Proofing Document Result Missing'
  PROOFING_RESOLUTION_RESULT_MISSING = 'Proofing Resolution Result Missing'
