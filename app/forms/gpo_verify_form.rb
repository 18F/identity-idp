class GpoVerifyForm
  ...
  def submit
    ...
    if result
      ...
      elsif fraud_review_check.fraud_check_failed? && threatmetrix_enabled?
    ...
    FormResponse.new(
      ...
      extra: {
        ...
        threatmetrix_check_failed: fraud_review_check.fraud_check_failed?,
      },
    )
  end
  ...
  def fraud_review_check
    @fraud_review_check ||= FraudReviewCheck.new(user)
  end
