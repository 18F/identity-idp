...
module SamlIdp
  class SignedInfoBuilder
    ...
    attr_accessor :reference_id, :digest_value, :raw_algorithm, :cloudhsm_key_label
    ...
    def raw
      ...
      builder.tag! 'ds:SignedInfo',
                   'xmlns:ds' => 'http://www.w3.org/2000/09/xmldsig#' do |signed_info|
