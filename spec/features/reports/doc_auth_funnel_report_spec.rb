  ...
  let(:doc_success_funnel) do
    {
      ...
      'mobile_back_image_error_count_average' => 0,
      'mobile_back_image_submit_count_average' => 0,
      'mobile_front_image_view_count_average' => 0,
      'mobile_front_image_view_percent' => 0,
      'mobile_front_image_error_count_average' => 0,
      'mobile_front_image_submit_count_average' => 0,
      ...
      'usps_address_error_count_average' => 0,
