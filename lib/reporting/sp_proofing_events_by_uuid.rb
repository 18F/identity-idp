  ...
  class SpProofingEventsByUuid
    ...
    def query(after_row:)
      base_query = <<~QUERY
        ...
        | fields
            ...
            if(name = "GetUspsProofingResultsJob: Enrollment status updated", properties.event_properties.enrollment_code, null) as ipp_enrollment_code_,
        ...
        | stats 
            ...
            earliest(ipp_enrollment_code_) as ipp_enrollment_code,
    ...
    def process_result_row(result_row)
      [
        ...
        result_row['ipp_enrollment_code'],
