...
RSpec.describe Idv::InPerson::StateIdController do
  ...
  describe 'before_actions' do
    ...
    context '#confirm_establishing_enrollment' do
      ...
      it 'redirects to document capture if not complete' do
        ...
        expect(response).to redirect_to idv_document_capture_url # redirect to specific IPP page?
      end
    end
  end
  ...
  describe '#show' do
    ...
    context 'with state_id controller flag enabled' do
