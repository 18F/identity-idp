  ...
  let(:happy_path_events) do
    {
      ...
      'IdV: doc auth image upload form submitted' => {
        success: true, errors: {}, submit_attempts: 1, remaining_submit_attempts: max_attempts - 1, user_id: user.uuid, flow_path: 'standard', front_image_fingerprint: an_instance_of(String), back_image_fingerprint: an_instance_of(String), selfie_image_fingerprint: nil, liveness_checking_required: boolean
      },
      ...
      'IdV: doc auth image upload vendor pii validation' => {
        success: true, errors: {}, user_id: user.uuid, submit_attempts: 1, remaining_submit_attempts: max_attempts - 1, flow_path: 'standard', attention_with_barcode: false, front_image_fingerprint: an_instance_of(String), back_image_fingerprint: an_instance_of(String), selfie_image_fingerprint: nil, liveness_checking_required: boolean, classification_info: {}
      },
  ...
  let(:happy_hybrid_path_events) do
    {
      ...
      'IdV: doc auth image upload form submitted' => {
        success: true, errors: {}, submit_attempts: 1, remaining_submit_attempts: max_attempts - 1, user_id: user.uuid, flow_path: 'hybrid', front_image_fingerprint: an_instance_of(String), back_image_fingerprint: an_instance_of(String), selfie_image_fingerprint: nil, liveness_checking_required: boolean
      },
      ...
      'IdV: doc auth image upload vendor pii validation' => {
        success: true, errors: {}, user_id: user.uuid, submit_attempts: 1, remaining_submit_attempts: max_attempts - 1, flow_path: 'hybrid', attention_with_barcode: false, front_image_fingerprint: an_instance_of(String), back_image_fingerprint: an_instance_of(String), selfie_image_fingerprint: nil, liveness_checking_required: boolean, classification_info: {}
      },
      'IdV: doc auth document_capture submitted' => {
  ...
  let(:happy_mobile_selfie_path_events) do
    {
      ...
      'IdV: doc auth image upload form submitted' => {
        success: true, errors: {}, submit_attempts: 1, remaining_submit_attempts: max_attempts - 1, user_id: user.uuid, flow_path: 'standard', front_image_fingerprint: an_instance_of(String), back_image_fingerprint: an_instance_of(String), selfie_image_fingerprint: an_instance_of(String), liveness_checking_required: boolean
      },
      'IdV: doc auth image upload vendor submitted' => hash_including(success: true, flow_path: 'standard', attention_with_barcode: false, doc_auth_result: 'Passed', liveness_checking_required: boolean),
      'IdV: doc auth image upload vendor pii validation' => {
