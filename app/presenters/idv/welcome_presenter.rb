...
module Idv
  class WelcomePresenter
    ...
    def initialize(decorated_sp_session, id_type_policy)
      @decorated_sp_session = decorated_sp_session
      @id_type_policy = id_type_policy
      @url_options = {}
    end
    ...
    attr_reader :decorated_sp_session, :id_type_policy
    ...
    def id_type_copy
      return t('doc_auth.instructions.bullet1b') if id_type_policy&.allow_passport?
