...
const getButtonHtml = () =>
  `<button type="button" class="usa-button usa-button--unstyled" aria-label="${t(
    'forms.buttons.back',
  )}">\u2039 ${t('forms.buttons.back')}</button>`;
const getBorderedButtonHtml = () =>
  `<div class="margin-top-5 padding-top-2 border-top border-primary-light"><button type="button" class="usa-button usa-button--unstyled" aria-label="${t(
    'forms.buttons.back',
  )}">\u2039 ${t('forms.buttons.back')}</button></div>`;
