...
RSpec.describe ReportMailer, type: :mailer do
  ...
  describe '#authentication_report' do
    let(:mail) do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq t('report_mailer.authentication_report.subject')
    end
    ...
    it 'renders the body' do
      ...
      expect(mail.attachments[1].filename).to eq 'authentication_report.csv'
    end
  end
