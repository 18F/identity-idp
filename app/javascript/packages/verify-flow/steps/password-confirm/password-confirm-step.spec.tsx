...
describe('PasswordConfirmStep', () => {
  ...
  describe('forgot password', () => {
    ...
    it('navigates to forgot password subpage', async () => {
      const { getByTitle } = render(<PasswordConfirmStep {...DEFAULT_PROPS} />);

      await userEvent.click(getByTitle('idv.forgot_password.link_text'));
    ...
    it('navigates back from forgot password subpage', async () => {
      const { getByRole, getByTitle } = render(<PasswordConfirmStep {...DEFAULT_PROPS} />);
