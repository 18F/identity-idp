  ...
  module Actions
    class VerifyDocumentAction < Idv::Steps::DocAuthBaseStep
      ...
      def enqueue_job
        ...
        applicant = image_params.to_h.slice('encryption_key', 'front_image_iv', 'back_image_iv', 'selfie_image_iv', 'front_image_url', 'back_image_url', 'selfie_image_url')
      ...
      def image_params
        params.permit([:encryption_key, :front_image_iv, :back_image_iv, :selfie_image_iv, :front_image_url, :back_image_url, :selfie_image_url])
      end
    end
  end
end
