...
feature 'Analytics Regression', js: true do
  ...
  let(:happy_path_events) do
    {
      'IdV: intro visited' => {},
      'IdV: doc auth welcome visited' => { flow_path: 'standard', step: 'welcome', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth welcome submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement visited' => { flow_path: 'standard', step: 'agreement', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth upload visited' => { flow_path: 'standard', step: 'upload', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth upload submitted' => { success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth document_capture visited' => { flow_path: 'standard', step: 'document_capture', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      ...
      'IdV: doc auth image upload vendor pii validation' => { success: true, errors: {}, user_id: nil, remaining_attempts: 3, flow_path: 'standard', attention_with_barcode: false },
      'IdV: doc auth verify_document_status submitted' => { success: true, errors: {}, remaining_attempts: 3, flow_path: 'standard', step: 'verify_document_status', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false, doc_auth_result: 'Passed', attention_with_barcode: false },
      'IdV: doc auth document_capture submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'document_capture', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn visited' => { flow_path: 'standard', step: 'ssn', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'ssn', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify visited' => { flow_path: 'standard', step: 'verify', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'verify', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify_wait visited' => { flow_path: 'standard', step: 'verify_wait', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth optional verify_wait submitted' => { success: true, errors: {}, address_edited: false, analytics_id: 'Doc Auth', proofing_results: { exception: nil, timed_out: false, context: { should_proof_state_id: true, adjudication_reason: 'pass_resolution_and_state_id', stages: { resolution: { vendor_name: 'ResolutionMock', errors: {}, exception: nil, success: true, timed_out: false, transaction_id: 'resolution-mock-transaction-id-123', reference: 'aaa-bbb-ccc', can_pass_with_additional_verification: false, attributes_requiring_additional_verification: [] }, state_id: { vendor_name: 'StateIdMock', errors: {}, success: true, timed_out: false, exception: nil, transaction_id: 'state-id-mock-transaction-id-456', verified_attributes: [], state: 'MT', state_id_jurisdiction: 'ND', state_id_number: '#############' } } } }, ssn_is_unique: true, step: 'verify_wait_step_show' },
      ...
      'IdV: Phone OTP Delivery Selection Submitted' => { success: true, errors: {}, otp_delivery_preference: 'sms', proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' } },
      'IdV: phone confirmation otp sent' => include(success: true, otp_delivery_preference: :sms, country_code: 'US', area_code: '202', proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }),
      ...
      'IdV: phone confirmation otp submitted' => { success: true, errors: {}, code_expired: false, code_matches: true, second_factor_attempts_count: 0, second_factor_locked_at: nil, proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' } },
  ...
  let(:gpo_path_events) do
    {
      ...
      'IdV: doc auth image upload form submitted' => { success: true, errors: {}, attempts: nil, remaining_attempts: 3, user_id: nil, flow_path: 'standard' },
      'IdV: doc auth image upload vendor pii validation' => { success: true, errors: {}, user_id: nil, remaining_attempts: 3, flow_path: 'standard', attention_with_barcode: false },
      'IdV: doc auth verify_document_status submitted' => { success: true, errors: {}, remaining_attempts: 3, flow_path: 'standard', step: 'verify_document_status', step_count: 1, attention_with_barcode: false, analytics_id: 'Doc Auth', irs_reproofing: false, doc_auth_result: 'Passed' },
      'IdV: doc auth document_capture submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'document_capture', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn visited' => { flow_path: 'standard', step: 'ssn', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'ssn', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify visited' => { flow_path: 'standard', step: 'verify', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false },
  ...
  let(:in_person_path_events) do
    {
      'IdV: doc auth welcome visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'welcome', step_count: 1, irs_reproofing: false },
      'IdV: doc auth welcome submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1, irs_reproofing: false },
      'IdV: doc auth agreement visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'agreement', step_count: 1, irs_reproofing: false },
      'IdV: doc auth agreement submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1, irs_reproofing: false },
      'IdV: doc auth upload visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'upload', step_count: 1, irs_reproofing: false },
      'IdV: doc auth upload submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1, irs_reproofing: false },
      'IdV: doc auth document_capture visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'document_capture', step_count: 1, irs_reproofing: false },
      'Frontend: IdV: front image added' => { 'width' => 284, 'height' => 38, 'mimeType' => 'image/png', 'source' => 'upload', 'size' => 3694, 'attempt' => 1, 'flow_path' => 'standard' },
      'Frontend: IdV: document capture async upload encryption' => { 'success' => true, 'flow_path' => 'standard' },
      'Frontend: IdV: back image added' => { 'width' => 284, 'height' => 38, 'mimeType' => 'image/png', 'source' => 'upload', 'size' => 3694, 'attempt' => 1, 'flow_path' => 'standard' },
      'Frontend: IdV: document capture async upload submitted' => { 'success' => true, 'trace_id' => nil, 'status_code' => 200, 'flow_path' => 'standard' },
      ...
      'IdV: doc auth verify_document_status submitted' => hash_including(success: true, flow_path: 'standard', step: 'verify_document_status', attention_with_barcode: true, doc_auth_result: 'Attention'),
      ...
      'IdV: in person proofing state_id visited' => { analytics_id: 'In Person Proofing', step: 'state_id', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      'IdV: in person proofing state_id submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, flow_path: 'standard', step: 'state_id', step_count: 1, irs_reproofing: false },
      'IdV: in person proofing address visited' => { analytics_id: 'In Person Proofing', step: 'address', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      'IdV: in person proofing address submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'address', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      'IdV: doc auth ssn visited' => { analytics_id: 'In Person Proofing', step: 'ssn', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      'IdV: doc auth ssn submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'ssn', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      ...
      'IdV: doc auth verify submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'verify', flow_path: 'standard', step_count: 1, irs_reproofing: false },
      ...
      'IdV: doc auth optional verify_wait submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'verify_wait_step_show', address_edited: false, ssn_is_unique: true, proofing_results: anything },
      ...
      'IdV: Phone OTP Delivery Selection Submitted' => { success: true, errors: {}, otp_delivery_preference: 'sms', proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' } },
      'IdV: phone confirmation otp sent' => hash_including(success: true, otp_delivery_preference: :sms, country_code: 'US', area_code: '202', proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }),
      ...
      'IdV: phone confirmation otp submitted' => { success: true, errors: {}, code_expired: false, code_matches: true, second_factor_attempts_count: 0, second_factor_locked_at: nil, proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' } },
