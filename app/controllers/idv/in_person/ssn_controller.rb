  ...
  module InPerson
    class SsnController < ApplicationController
      ...
      def show
          ...
          # GINA TO DO - FIGURE OUT UPDATING SSN NEXT LINE
      ...
      def next_url
          if pii_from_user[:state] == 'PR' && !updating_ssn?
          idv_address_url
          else
          idv_verify_info_url
          end
      ...
      def renders_404_if_flag_not_set
        render_not_found unless IdentityConfig.store.in_person_ssn_controller_enabled
      end
