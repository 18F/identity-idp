module Encryption
  class UakPasswordVerifier
    PasswordDigest =
      RedactedStruct.new(:encrypted_password, :encryption_key, :password_salt, :password_cost) do
    ...
    def self.digest(password)
      ...
      uak.build
      PasswordDigest.new(uak.encrypted_password, uak.encryption_key, salt, uak.cost).to_s
    end
