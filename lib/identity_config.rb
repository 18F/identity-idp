class IdentityConfig
  ...
  def self.build_store(config_map)
    ...
    config.add(:email_reminder_early_benchmark, type: :integer)
    config.add(:email_reminder_late_benchmark, type: :integer)
    config.add(:email_reminder_final_benchmark, type: :integer)
