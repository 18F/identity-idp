...
ActiveRecord::Schema[8.0].define(version: 2026_05_29_170050) do
  ...
  create_table "document_capture_sessions", force: :cascade do |t|
    ...
    t.boolean "pending_agent_proofed_user", default: false, null: false
    ...
    t.index ["user_id", "pending_agent_proofed_user"], name: "idx_on_user_id_pending_agent_proofed_user_8221f4405c"
