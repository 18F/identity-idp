  ...
  return (
    <>
      ...
      <div className="display-flex">
        <img src={getAssetPath('idv/selfie-capture-help.svg')} alt="A person with their face in a green oval."/>
        <div className="margin-left-2">
          Line up your face with the green circle. Hold still and wait for the tool to capture a photo.
        </div>
      </div>
      <div className="display-flex">
        <img src={getAssetPath('idv/selfie-capture-accept-help.svg')} alt="A finger taps a checkmark under the face to confirm the photo."/>
        <div className="margin-left-2">
