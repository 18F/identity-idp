...
module AttemptsApi
  class Cacher
    ...
    def save(password:, profile:)
      return unless profile&.encrypted_attempts_file_reference.present?

      decrypted_events = profile.decrypt_user_proofing_events(password:)
