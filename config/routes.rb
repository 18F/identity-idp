...
Rails.application.routes.draw do
  ...
  scope '(:locale)', locale: /#{I18n.available_locales.join('|')}/ do
    ...
    scope '/verify', module: 'idv', as: 'idv' do
      ...
      get '/socure/document_capture_errors' => 'socure/document_capture_errors#show'
      get '/socure/document_capture_goto_in_person' => 'socure/document_capture_errors#goto_in_person', as: :socure_document_capture_goto_in_person
      ...
      get '/hybrid_mobile/socure/document_capture_errors' => 'hybrid_mobile/socure/document_capture_errors#show'
      get '/hybrid_mobile/socure/document_capture_goto_in_person' => 'hybrid_mobile/socure/document_capture_errors#goto_in_person', as: :hybrid_mobile_socure_document_capture_goto_in_person
