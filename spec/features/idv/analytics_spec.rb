...
feature 'Analytics Regression', js: true do
  ...
  let(:in_person_path_events) do
    {
      'IdV: doc auth welcome visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'welcome', step_count: 1 },
      'IdV: doc auth welcome submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1 },
      'IdV: doc auth agreement visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'agreement', step_count: 1 },
      'IdV: doc auth agreement submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1 },
      'IdV: doc auth upload visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'upload', step_count: 1 },
      'IdV: doc auth upload submitted' => { analytics_id: 'Doc Auth', success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1 },
      'IdV: doc auth document_capture visited' => { analytics_id: 'Doc Auth', flow_path: 'standard', step: 'document_capture', step_count: 1 },
      'Frontend: IdV: front image added' => { 'width' => 284, 'height' => 38, 'mimeType' => 'image/png', 'source' => 'upload', 'size' => 3694, 'attempt' => 1, 'flow_path' => 'standard' },
      'Frontend: IdV: document capture async upload encryption' => { 'success' => true, 'flow_path' => 'standard' },
      'Frontend: IdV: back image added' => { 'width' => 284, 'height' => 38, 'mimeType' => 'image/png', 'source' => 'upload', 'size' => 3694, 'attempt' => 1, 'flow_path' => 'standard' },
      'Frontend: IdV: document capture async upload submitted' => { 'success' => true, 'trace_id' => nil, 'status_code' => 200, 'flow_path' => 'standard' },
      'IdV: doc auth image upload form submitted' => { success: true, errors: {}, attempts: nil, remaining_attempts: 3, user_id: nil, flow_path: 'standard' },
      'IdV: doc auth image upload vendor submitted' => include(success: true, flow_path: 'standard', attention_with_barcode: true, doc_auth_result: 'Attention'),
      'IdV: doc auth verify_document_status submitted' => include(success: true, flow_path: 'standard', step: 'verify_document_status', attention_with_barcode: true, doc_auth_result: 'Attention'),
      ...
      'IdV: in person proofing state_id visited' => { analytics_id: 'In Person Proofing', step: 'state_id', flow_path: 'standard', step_count: 1 },
      'IdV: in person proofing state_id submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, flow_path: 'standard', step: 'state_id', step_count: 1 },
      'IdV: in person proofing address visited' => { analytics_id: 'In Person Proofing', step: 'address', flow_path: 'standard', step_count: 1 },
      'IdV: in person proofing address submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'address', flow_path: 'standard', step_count: 1 },
      'IdV: doc auth ssn visited' => { analytics_id: 'In Person Proofing', step: 'ssn', flow_path: 'standard', step_count: 1 },
      'IdV: doc auth ssn submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'ssn', flow_path: 'standard', step_count: 1 },
      'IdV: doc auth verify visited' => { analytics_id: 'In Person Proofing', step: 'verify', flow_path: 'standard', step_count: 1 },
      'IdV: doc auth verify submitted' => { analytics_id: 'In Person Proofing', errors: {}, success: true, step: 'verify', flow_path: 'standard', step_count: 1 },
      ...
      'IdV: phone confirmation otp sent' => include(success: true, otp_delivery_preference: :sms, country_code: 'US', area_code: '202', proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }),
