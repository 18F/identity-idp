...
cron_1h = '0 * * * *'
cron_24h = '0 0 * * *'
cron_24h_4_UTC = '12 4 * * *' # 0400 UTC + 12 min, staggered from whatever else runs at 0400 UTC
cron_24h_5_UTC = '12 5 * * *' # 0500 UTC + 12 min, staggered from whatever else runs at 0500 UTC
