...
describe('document-capture/components/documents-step', () => {
  ...
  it('renders the hybrid flow warning if the flow is hybrid', () => {
    const { getByText } = render(
      <DeviceContext.Provider value={{ isMobile: true }}>
        <UploadContextProvider flowPath="hybrid" endpoint="unused" idType="drivers_license">
          <DocumentsStep
            value={{}}
            onChange={() => undefined}
            errors={[]}
  ...
  it('does not render the hybrid flow warning if the flow is standard (default)', () => {
    const { queryByText } = render(
      <DeviceContext.Provider value={{ isMobile: true }}>
        <UploadContextProvider flowPath="standard" endpoint="unused" idType="drivers_license">
          <DocumentsStep
            value={{}}
            onChange={() => undefined}
            errors={[]}
