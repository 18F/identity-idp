class IdentityConfig
  ...
  def self.build_store(config_map)
    ...
    config.add(:lexisnexis_threatmatrix_base_url, type: :string)
    config.add(:lexisnexis_threatmatrix_request_mode, type: :string)
    config.add(:lexisnexis_threatmatrix_account_id, type: :string)
    config.add(:lexisnexis_threatmatrix_username, type: :string)
    config.add(:lexisnexis_threatmatrix_password, type: :string)
    config.add(:lexisnexis_threatmatrix_instant_verify_timeout, type: :float)
    config.add(:lexisnexis_threatmatrix_instant_verify_workflow, type: :string)
