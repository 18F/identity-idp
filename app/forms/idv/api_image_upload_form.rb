  ...
  class ApiImageUploadForm
    ...
    def update_analytics(client_response)
      ...
      irs_attempts_api_tracker.idv_document_upload_submitted(
        ...
        front_image_uuid: stored_image_result&.front_uuid,
        front_image_content_type: stored_image_result && front.content_type,
        front_image_encryption_key: stored_image_result&.front_encryption_key,
        back_image_uuid: stored_image_result&.back_uuid,
        back_image_content_type: stored_image_result && back.content_type,
