...
class MemorableDateComponent < BaseComponent
  ...
  # Whether literal placeholder values (99/00) are permitted. Exposed to the
  # client-side <lg-memorable-date> element so it can skip real-date validation.
  def allow_placeholder_values?
