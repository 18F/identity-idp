class IdentityConfig
  ...
  def self.build_store(config_map)
    ...
    config.add(:database_events_name, type: :string)
    config.add(:databasee_events_username, type: :string)
    config.add(:database_events_host, type: :string)
    config.add(:databasee_events_password, type: :string)
