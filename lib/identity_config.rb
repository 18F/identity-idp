...
module IdentityConfig
  ...
  BUILDER = proc do |config|
    ...
    config.add(:api_transaction_count_external_emails, type: :json)
    config.add(:api_transaction_count_internal_emails, type: :json)
    ...
    config.add(:idv_clear1_api_base_url, type: :string)
    config.add(:idv_clear1_api_key, type: :string)
    ...
    config.add(:idv_phone_verification_dual_vendor_check_ddp_lexis_nexis_percent, type: :integer)
    config.add(:idv_phone_verification_dual_vendor_check_enabled, type: :boolean)
    config.add(:idv_phone_verification_dual_vendor_check_socure_percent, type: :integer)
    ...
    config.add(:key_metrics_external_emails, type: :json)
    config.add(:key_metrics_internal_emails, type: :json)
    config.add(:key_metrics_s3_external_emails, type: :json)
    config.add(:key_metrics_s3_internal_emails, type: :json)
    ...
    config.add(:usps_confirmation_max_days_contiguous_states, type: :integer)
