...
export const fallbackImageForm = () =>
  document.querySelector('#acuant-fallback-image-form');
export const imageFileInput = () => document.querySelector('#doc_auth_image');
export const imageDataUrlInput = () =>
  document.querySelector('#doc_auth_image_data_url');
// Acuant UI containers
export const acuantSdkUploadForm = () =>
  document.querySelector('#acuant-sdk-upload-form');
export const acuantSdkSpinner = () =>
  document.querySelector('#acuant-sdk-spinner');
export const acuantSdkCaptureView = () =>
  document.querySelector('#acuant-sdk-capture-view');
export const acuantSdkCaptureViewCloseButton = () =>
  document.querySelector('#acuant-sdk-capture-view-close');
export const acuantSdkContinueForm = () =>
  document.querySelector('#acuant-sdk-continue-form');
// Acuant UI elements
export const acuantSdkCaptureButton = () =>
  document.querySelector('#acuant-sdk-capture');
export const acuantSdkPreviewImage = () =>
  document.querySelector('#acuant-sdk-preview');
// Fallback UI elements
export const acuantSdkFallbackText = () =>
  document.querySelector('#acuant-fallback-text');
export const acuantSdkFallbackLink = () =>
  document.querySelector('#acuant-fallback-link');

export const fetchSdkInitializationCredentials = () =>
  document.querySelector('meta[name="acuant-sdk-initialization-creds"]')
    .content;

export const fetchSdkInitializationEndpoint = () =>
  document.querySelector('meta[name="acuant-sdk-initialization-endpoint"]')
    .content;
...
export const addClickEventListenerToAcuantCaptureViewCloseButton = (
  clickCallback,
) => {
...
export const showAcuantSdkContainer = (container) => {
  ...
  switch (container) {
    ...
    case 'spinner':
      ...
      break;
    case 'capture-view':
      addClickEventListenerToAcuantCaptureViewCloseButton(
