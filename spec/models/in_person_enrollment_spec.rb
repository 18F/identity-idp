...
RSpec.describe InPersonEnrollment, type: :model do
  ...
  describe '#profile_has_deactivation_reason?' do
    ...
    context "when the enrollment's profile has a deactivation reason" do
      ...
      it 'returns true' do
        expect(enrollment.profile_has_deactivation_reason?).to be(true)
      end
    end

    context 'when the profile does not have a deactivation reason' do
      it 'returns false' do
        expect(enrollment.profile_has_deactivation_reason?).to be(false)
      end
    end
  end
