...
module UspsInPersonProofing
  class EnrollmentHelper
    class << self
      def schedule_in_person_enrollment(user, pii, enhanced_ipp, opt_in = nil)
        ...
        enrollment_code = create_usps_enrollment(enrollment, pii, enhanced_ipp)
      ...
      def create_usps_enrollment(enrollment, pii, enhanced_ipp)
        ...
        response = proofer.request_enroll(applicant, enhanced_ipp)
