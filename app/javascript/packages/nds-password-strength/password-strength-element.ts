...
declare global {
  interface HTMLElementTagNameMap {
    'lg-nds-password-strength': PasswordStrengthElement;
  }
}

if (!customElements.get('lg-nds-password-strength')) {
  customElements.define('lg-nds-password-strength', PasswordStrengthElement);
}
