class IdentityConfig
  ...
  def self.build_store(config_map)
    ...
    config.add(:arcgis_api_token_prefetch_ttl_sliding_increment_seconds, type: :integer)
    config.add(:arcgis_api_token_prefetch_ttl_sliding_times, type: :integer)
    config.add(:arcgis_get_token_max_retries, type: :integer)
    ...
    config.add(:irs_attempt_api_idv_events_enabled, type: :boolean)
