  ...
  module Tasks
    class BaseTask
      ...
      ALLOWED_UNTRANSLATED_KEYS = [
        ...
        # need to be fixed
        { key: 'datetime.dotiw.days.one', locales: %i[zh] },
        { key: 'datetime.dotiw.days.other', locales: %i[zh] },
        { key: 'datetime.dotiw.hours.one', locales: %i[zh] },
        { key: 'datetime.dotiw.hours.other', locales: %i[zh] },
        { key: 'datetime.dotiw.less_than_x', locales: %i[zh] },
        { key: 'datetime.dotiw.months.one', locales: %i[zh] },
        { key: 'datetime.dotiw.months.other', locales: %i[zh] },
        { key: 'datetime.dotiw.weeks.one', locales: %i[zh] },
        { key: 'datetime.dotiw.weeks.other', locales: %i[zh] },
        { key: 'datetime.dotiw.years.one', locales: %i[zh] },
        { key: 'datetime.dotiw.years.other', locales: %i[zh] },
