module TwoFactorAuthenticatable
  ...
  def after_otp_action_url
    personal_key_manager = two_factor_method_manager.configuration_manager(:personal_key)
  ...
  def personal_key_unavailable?
    idv_or_confirmation_context? ||
      profile_context? ||
      !two_factor_method_manager.two_factor_enabled?([:personal_key])
  end
  ...
  def generic_data
    {
      ...
      has_piv_cac_configured: two_factor_method_manager.two_factor_enabled?([:piv_cac]),
      reauthn: reauthn?,
