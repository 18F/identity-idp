      ...
      context 'when a selfie is required', :js do
        ...
        it 'proceeds to the next page with valid info' do
          ...
          perform_in_browser(:mobile) do
            ...
            expect(page).to have_content(t('idv.errors.technical_difficulties'))
    ...
    context 'user times out waiting for result' do
      ...
      it 'presents options to try again or try in person', js: true do
        ...
        perform_in_browser(:mobile) do
          ...
          expect(page).to have_content(I18n.t('idv.errors.technical_difficulties'))
        ...
        perform_in_browser(:mobile) do
          ...
          expect(page).to have_text(
            t(
              ...
              count: IdentityConfig.store.doc_auth_max_attempts,
            ),
          )
          expect(@analytics).to have_logged_event(:idv_socure_document_request_submitted)
