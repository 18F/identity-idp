...
RSpec.describe EmailContext do
  ...
  describe '#last_sign_in_email_address' do
    it 'returns the email with the most recent last_sign_in_at date' do
      last_sign_in_email_address = create(:email_address, user:, last_sign_in_at: 1.day.ago)
      create(:email_address, user:, last_sign_in_at: 2.days.ago)
    ...
    it 'does not return an email with a null last_sign_in_at date' do
      last_sign_in_email_address = create(:email_address, user:, last_sign_in_at: 1.day.ago)
      create(:email_address, user:, last_sign_in_at: nil)
