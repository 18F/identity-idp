  ...
  let(:happy_mobile_selfie_path_events) do
    {
      ...
      :idv_selfie_image_added => {
        acuant_version: anything, captureAttempts: 1, failedImageResubmission: nil, fingerprint: 'aIzxkX_iMtoxFOURZr55qkshs53emQKUOr7VfTf6G1Q', flow_path: 'standard', height: 38, mimeType: 'image/png', size: 3694, source: 'upload', width: 284, liveness_checking_required: boolean
      },
      'IdV: doc auth ssn visited' => {
