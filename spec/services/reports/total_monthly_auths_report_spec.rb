...
describe Reports::TotalMonthlyAuthsReport do
  ...
  it 'returns the total monthly auths' do
    MonthlySpAuthCount.create(issuer: 'foo', ial: 1, year_month: '201901', user_id: 2, auth_count: 7)
    MonthlySpAuthCount.create(issuer: 'foo', ial: 1, year_month: '201901', user_id: 3, auth_count: 3)
