module Idv
  class SessionErrorsController < ApplicationController
    ...
    def warning
      @remaining_attempts = RedisThrottle.new(
        user: effective_user,
    ...
    def throttled
      @expires_at = RedisThrottle.new(user: effective_user, throttle_type: :idv_doc_auth).expires_at
    end
