...
ActiveRecord::Schema[7.0].define(version: 2023_04_17_232211) do
  ...
  create_table "profiles", id: :serial, force: :cascade do |t|
    ...
    t.datetime "fraud_rejected_at"
    t.datetime "fraud_reviewing_at"
    t.index ["fraud_rejected_at"], name: "index_profiles_on_fraud_rejected_at"
    ...
    t.index ["fraud_reviewing_at"], name: "index_profiles_on_fraud_reviewing_at"
