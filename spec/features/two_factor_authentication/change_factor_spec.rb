...
feature 'Changing authentication factor' do
  describe 'requires re-authenticating' do
    ...
    scenario 'editing phone number' do
      ...
      @previous_phone_confirmed_at = user.mfa.phone_configurations.reload.first.confirmed_at
      ...
      expect(user.mfa.phone_configurations.reload.first.phone).to_not eq new_phone
      expect(page).to have_link t('forms.two_factor.try_again'), href: manage_phone_path
      ...
      expect(
        user.mfa.phone_configurations.reload.first.confirmed_at
    ...
    scenario 'editing phone number with no voice otp support only allows sms delivery' do
      ...
      user.mfa.phone_configurations.first.update(delivery_preference: 'voice')
    ...
    scenario 'waiting too long to change phone number' do
      ...
      old_phone = user.mfa.phone_configurations.first.phone
      visit manage_phone_path
      update_phone_number
