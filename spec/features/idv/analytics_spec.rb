...
feature 'Analytics Regression', js: true do
  ...
  let(:happy_path_events) do
    {
      'IdV: intro visited' => {},
      'IdV: doc auth welcome visited' => { flow_path: 'standard', step: 'welcome', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth welcome submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth agreement visited' => { flow_path: 'standard', step: 'agreement', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth agreement submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth upload visited' => { flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth upload submitted' => { success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth document_capture visited' => { flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      ...
      'IdV: doc auth document_capture submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth ssn visited' => { flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth ssn submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth verify visited' => { flow_path: 'standard', step: 'verify', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth verify submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'verify', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
  ...
  let(:in_person_path_events) do
    {
      ...
      'IdV: in person proofing state_id visited' => { step: 'state_id', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: in person proofing state_id submitted' => { success: true, flow_path: 'standard', step: 'state_id', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: in person proofing address visited' => { step: 'address', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: in person proofing address submitted' => { success: true, step: 'address', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth ssn visited' => { analytics_id: 'In Person Proofing', step: 'ssn', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth ssn submitted' => { analytics_id: 'In Person Proofing', success: true, step: 'ssn', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth verify visited' => { analytics_id: 'In Person Proofing', step: 'verify', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
      'IdV: doc auth verify submitted' => { analytics_id: 'In Person Proofing', success: true, step: 'verify', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: :default },
