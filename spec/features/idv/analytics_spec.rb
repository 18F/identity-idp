  ...
  let(:in_person_path_events) do
    {
      ...
      'IdV: in person proofing state_id visited' => { step: 'state_id', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: in person proofing state_id submitted' => { success: true, flow_path: 'standard', step: 'state_id', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: in person proofing address visited' => { step: 'address', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: in person proofing address submitted' => { success: true, step: 'address', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth ssn visited' => { analytics_id: 'In Person Proofing', step: 'ssn', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth ssn submitted' => { analytics_id: 'In Person Proofing', success: true, step: 'ssn', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth verify visited' => { analytics_id: 'In Person Proofing', step: 'verify', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth verify submitted' => { analytics_id: 'In Person Proofing', success: true, step: 'verify', flow_path: 'standard', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false },
