...
module IdentityConfig
  ...
  BUILDER = proc do |config|
    ...
    config.add(:doc_auth_lexis_nexis_ddp_enabled, type: :boolean)
    ...
    config.add(:lexisnexis_trueid_liveness_cropping_policy, type: :string)
    config.add(:lexisnexis_trueid_liveness_nocropping_policy, type: :string)
    config.add(:lexisnexis_trueid_noliveness_cropping_policy, type: :string)
    config.add(:lexisnexis_trueid_noliveness_nocropping_policy, type: :string)
