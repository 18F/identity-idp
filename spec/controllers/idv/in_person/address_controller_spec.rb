...
RSpec.describe Idv::InPerson::AddressController do
  ...
  describe 'AAMVA integration' do
    ...
    context 'when redirecting to SSN page (new address flow)' do
      let(:params) do
        {
          in_person_address: {
            address1: InPersonHelper::GOOD_ADDRESS1,
            address2: InPersonHelper::GOOD_ADDRESS2,
            city: InPersonHelper::GOOD_CITY,
            zipcode: InPersonHelper::GOOD_ZIPCODE,
            state: InPersonHelper::GOOD_STATE,
          },
        }
      end
    ...
    context 'when updating address (redirecting to verify_info)' do
      let(:params) do
        {
          in_person_address: {
            address1: '123 New Residential Ave',
            address2: '',
            city: 'Anytown',
            zipcode: '12345',
            state: 'CA',
      ...
      it 'redirects to verify_info page' do
        put :update, params: params
