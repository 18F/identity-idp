...
RSpec.describe Profile do
  ...
  describe '#activate_after_passing_in_person' do
    it 'activates a profile if it passes in person proofing' do
      ...
      expect(profile.in_person_verification_pending?).to eq(true)
      expect(profile.in_person_verification_pending_at).to_not eq(nil)
      ...
      expect(profile.in_person_verification_pending?).to eq(false)
  ...
  describe '#deactivate_for_in_person_verification_and_schedule_enrollment' do
    it 'sets deactivation reason to in_person_verification_pending' do
      ...
      expect(profile.in_person_verification_pending_at).to_not be_nil # changed
      expect(profile.fraud_review_pending?).to eq(false)
      expect(profile.gpo_verification_pending_at).to be_nil
      expect(profile.initiating_service_provider).to be_nil
      expect(profile.verified_at).to be_nil
