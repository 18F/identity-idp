...
Rails.application.routes.draw do
  ...
  scope '(:locale)', locale: /#{I18n.available_locales.join('|')}/ do
    ...
    get '/sign_up/webauthn_platform_setup' => 'sign_up/webauthn_platform_setup#new', as: :webauthn_platform_setup
    post '/sign_up/webauthn_platform_setup' => 'sign_up/webauthn_platform_setup#create'
