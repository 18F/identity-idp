  ...
  let(:happy_path_events) do
    {
      ...
      'IdV: doc auth welcome visited' => {
        step: 'welcome', analytics_id: 'Doc Auth', irs_reproofing: false, skip_hybrid_handoff: nil, ab_tests: { lexisnexis_instant_verify_workflow_ab_test_bucket: :default }
      },
      'IdV: doc auth welcome submitted' => {
        step: 'welcome', analytics_id: 'Doc Auth', irs_reproofing: false, skip_hybrid_handoff: nil, ab_tests: { lexisnexis_instant_verify_workflow_ab_test_bucket: :default }
      },
      'IdV: doc auth agreement visited' => {
        step: 'agreement', analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }
      },
      'IdV: consent checkbox toggled' => {
        checked: true,
      },
      'IdV: doc auth agreement submitted' => {
        success: true, errors: {}, step: 'agreement', analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }
      },
      'IdV: doc auth hybrid handoff visited' => {
        step: 'hybrid_handoff', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false
      },
      'IdV: doc auth hybrid handoff submitted' => {
        success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'hybrid_handoff', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false
      },
      'IdV: doc auth document_capture visited' => {
        flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false
      },
      ...
      'IdV: doc auth document_capture submitted' => {
        success: true, errors: {}, flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false
      },
      'IdV: doc auth ssn visited' => {
        flow_path: 'standard', step: 'ssn', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth ssn submitted' => {
        success: true, errors: {}, flow_path: 'standard', step: 'ssn', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify visited' => {
        flow_path: 'standard', step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify submitted' => {
        flow_path: 'standard', step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify proofing results' => {
        success: true, errors: {}, flow_path: 'standard', address_edited: false, address_line2_present: false, analytics_id: 'Doc Auth', ssn_is_unique: true, step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, irs_reproofing: false, skip_hybrid_handoff: nil,
      ...
      'IdV: phone of record visited' => {
        ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
      ...
      'IdV: phone confirmation form' => {
        success: true, errors: {}, phone_type: :mobile, types: [:fixed_or_mobile], carrier: 'Test Mobile Carrier', country_code: 'US', area_code: '202', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, otp_delivery_preference: 'sms',
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass' }
      },
      ...
      'IdV: phone confirmation otp submitted' => {
        success: true, code_expired: false, code_matches: true, second_factor_attempts_count: 0, second_factor_locked_at: nil, errors: {}, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
      :idv_enter_password_visited => {
        address_verification_method: 'phone', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
      :idv_enter_password_submitted => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, fraud_review_pending: false, fraud_rejection: false, gpo_verification_pending: false, in_person_verification_pending: false, deactivation_reason: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
  ...
  let(:happy_hybrid_path_events) do
    {
      ...
      'IdV: doc auth hybrid handoff submitted' => {
        success: true, errors: hash_including(message: nil), destination: :link_sent, flow_path: 'hybrid', step: 'hybrid_handoff', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false, telephony_response: hash_including(errors: {}, message_id: 'fake-message-id', request_id: 'fake-message-request-id', success: true)
      },
      'IdV: doc auth document_capture visited' => {
        flow_path: 'hybrid', step: 'document_capture', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'Frontend: IdV: front image added' => {
      ...
      'IdV: doc auth document_capture submitted' => {
        success: true, errors: {}, flow_path: 'hybrid', step: 'document_capture', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth ssn visited' => {
        flow_path: 'hybrid', step: 'ssn', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth ssn submitted' => {
        success: true, errors: {}, flow_path: 'hybrid', step: 'ssn', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify visited' => {
        flow_path: 'hybrid', step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify submitted' => {
        flow_path: 'hybrid', step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth verify proofing results' => {
        success: true, errors: {}, flow_path: 'hybrid', address_edited: false, address_line2_present: false, analytics_id: 'Doc Auth', ssn_is_unique: true, step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, irs_reproofing: false, skip_hybrid_handoff: nil,
        proofing_results: { exception: nil, timed_out: false, threatmetrix_review_status: 'pass', context: { device_profiling_adjudication_reason: 'device_profiling_result_pass', resolution_adjudication_reason: 'pass_resolution_and_state_id', should_proof_state_id: true, stages: { resolution: { success: true, errors: {}, exception: nil, timed_out: false, transaction_id: 'resolution-mock-transaction-id-123', reference: 'aaa-bbb-ccc', can_pass_with_additional_verification: false, attributes_requiring_additional_verification: [], vendor_name: 'ResolutionMock', vendor_workflow: nil }, residential_address: { attributes_requiring_additional_verification: [], can_pass_with_additional_verification: false, errors: {}, exception: nil, reference: '', success: true, timed_out: false, transaction_id: '', vendor_name: 'ResidentialAddressNotRequired', vendor_workflow: nil }, state_id: { success: true, errors: {}, exception: nil, mva_exception: nil, timed_out: false, transaction_id: 'state-id-mock-transaction-id-456', vendor_name: 'StateIdMock', verified_attributes: [], state: 'MT', state_id_jurisdiction: 'ND', state_id_number: '#############' }, threatmetrix: threatmetrix_response } } }
      },
      'IdV: phone of record visited' => {
        ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
  ...
  let(:gpo_path_events) do
    {
      ...
      'IdV: doc auth hybrid handoff submitted' => {
        success: true, errors: {}, destination: :document_capture, flow_path: 'standard', redo_document_capture: nil, step: 'hybrid_handoff', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', skip_hybrid_handoff: nil, irs_reproofing: false
      },
      'IdV: doc auth document_capture visited' => {
        flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'Frontend: IdV: front image added' => {
        width: 284, height: 38, mimeType: 'image/png', source: 'upload', size: 3694, captureAttempts: 1, flow_path: 'standard', acuant_sdk_upgrade_a_b_testing_enabled: 'false', use_alternate_sdk: anything, acuant_version: anything, acuantCaptureMode: nil, fingerprint: anything, failedImageResubmission: boolean, documentType: nil, dpi: nil, glare: nil, glareScoreThreshold: nil, isAssessedAsBlurry: nil, isAssessedAsGlare: nil, isAssessedAsUnsupported: nil, moire: nil, sharpness: nil, sharpnessScoreThreshold: nil, assessment: nil
      },
      ...
      'IdV: doc auth document_capture submitted' => {
        success: true, errors: {}, flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'IdV: doc auth ssn visited' => {
        flow_path: 'standard', step: 'ssn', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      ...
      'IdV: USPS address letter requested' => {
        resend: false, phone_step_attempts: 0, first_letter_requested_at: nil, hours_since_first_letter: 0, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass' }
      },
      ...
      :idv_enter_password_visited => {
        address_verification_method: 'gpo', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
      ...
      'IdV: USPS address letter enqueued' => {
        enqueued_at: Time.zone.now.utc, resend: false, phone_step_attempts: 0, first_letter_requested_at: Time.zone.now.utc, hours_since_first_letter: 0, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'gpo_letter' }
      },
      :idv_enter_password_submitted => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, fraud_review_pending: false, fraud_rejection: false, gpo_verification_pending: true, in_person_verification_pending: false, deactivation_reason: nil,
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'gpo_letter' }
      },
      'IdV: final resolution' => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, fraud_review_pending: false, fraud_rejection: false, gpo_verification_pending: true, in_person_verification_pending: false, deactivation_reason: nil,
  ...
  let(:in_person_path_events) do
    {
      ...
      'IdV: in person proofing address visited' => {
        step: 'address', flow_path: 'standard', analytics_id: 'In Person Proofing', irs_reproofing: false, same_address_as_id: false, opted_in_to_in_person_proofing: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil
      },
      'IdV: in person proofing residential address submitted' => {
        success: true, step: 'address', flow_path: 'standard', analytics_id: 'In Person Proofing', irs_reproofing: false, errors: {}, same_address_as_id: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil
      },
      'IdV: doc auth ssn visited' => {
        analytics_id: 'In Person Proofing', step: 'ssn', flow_path: 'standard', irs_reproofing: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, same_address_as_id: false
      },
      'IdV: doc auth ssn submitted' => {
        analytics_id: 'In Person Proofing', success: true, step: 'ssn', flow_path: 'standard', irs_reproofing: false, errors: {}, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, same_address_as_id: false
      },
      'IdV: doc auth verify visited' => {
        analytics_id: 'In Person Proofing', step: 'verify', flow_path: 'standard', irs_reproofing: false, same_address_as_id: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil
      },
      'IdV: doc auth verify submitted' => {
        analytics_id: 'In Person Proofing', step: 'verify', flow_path: 'standard', irs_reproofing: false, same_address_as_id: false, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil
      },
      'IdV: doc auth verify proofing results' => {
        success: true, errors: {}, flow_path: 'standard', address_edited: false, address_line2_present: false, analytics_id: 'In Person Proofing', ssn_is_unique: true, step: 'verify', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, irs_reproofing: false, same_address_as_id: false, skip_hybrid_handoff: nil,
      ...
      :idv_enter_password_visited => {
        ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, address_verification_method: 'phone',
        proofing_components: { document_check: 'usps', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
      :idv_enter_password_submitted => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, fraud_review_pending: false, fraud_rejection: false, gpo_verification_pending: false, in_person_verification_pending: true, deactivation_reason: nil,
        proofing_components: { document_check: 'usps', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
      'IdV: final resolution' => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, fraud_review_pending: false, fraud_rejection: false, gpo_verification_pending: false, in_person_verification_pending: true, deactivation_reason: nil,
  ...
  let(:happy_selfie_path_events) do
    {
      ...
      'IdV: doc auth document_capture visited' => {
        flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, skip_hybrid_handoff: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      'Frontend: IdV: front image added' => {
        width: 284, height: 38, mimeType: 'image/png', source: 'upload', size: 3694, captureAttempts: 1, flow_path: 'standard', acuant_sdk_upgrade_a_b_testing_enabled: 'false', use_alternate_sdk: anything, acuant_version: anything, acuantCaptureMode: nil, fingerprint: anything, failedImageResubmission: boolean, documentType: nil, dpi: nil, glare: nil, glareScoreThreshold: nil, isAssessedAsBlurry: nil, isAssessedAsGlare: nil, isAssessedAsUnsupported: nil, moire: nil, sharpness: nil, sharpnessScoreThreshold: nil, assessment: nil
      },
      ...
      'IdV: doc auth document_capture submitted' => {
        success: true, errors: {}, flow_path: 'standard', step: 'document_capture', redo_document_capture: nil, skip_hybrid_handoff: nil, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, analytics_id: 'Doc Auth', irs_reproofing: false
      },
      ...
      'IdV: phone confirmation otp submitted' => {
        success: true, ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil, code_expired: false, code_matches: true, second_factor_attempts_count: 0, second_factor_locked_at: nil, errors: {},
        proofing_components: { document_check: 'mock', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', threatmetrix: threatmetrix, threatmetrix_review_status: 'pass', address_check: 'lexis_nexis_address' }
      },
      :idv_enter_password_visited => {
        address_verification_method: 'phone', ab_tests: { acuant_sdk_upgrade_ab_test_bucket: :default, lexisnexis_instant_verify_workflow_ab_test_bucket: :default }, skip_hybrid_handoff: nil,
