...
module Features
  module SessionHelper
    ...
    def stub_piv_cac_service
      ...
      allow(Identity::Hostdata.settings).to receive(:piv_cac_service_url).and_return('http://piv.example.com/')
      allow(Identity::Hostdata.settings).to receive(:piv_cac_verify_token_url).and_return('http://piv.example.com/')
