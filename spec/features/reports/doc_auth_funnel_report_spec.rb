  ...
  let(:doc_success_funnel) do
    {
      ...
      'usps_address_submit_count_average' => 0.0,
      'usps_address_submit_percent' => 0.0,
      'usps_address_error_count_average' => 0.0,
      'usps_address_view_count_average' => 0.0,
      'usps_address_view_percent' => 0.0,
      'usps_letter_sent_view_count_average' => 0.0,
      'usps_letter_sent_view_percent' => 0.0,
