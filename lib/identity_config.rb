...
module IdentityConfig
  ...
  BUILDER = proc do |config|
    ...
    config.add(:allowed_secured_data_providers, type: :json)
    ...
    config.add(:redis_secured_data_api_pool_size, type: :integer)
    config.add(:redis_secured_data_api_url, type: :string)
    ...
    config.add(:secured_data_api_enabled, type: :boolean)
    config.add(:secured_data_api_event_ttl_seconds, type: :integer)
    config.add(:secured_data_api_signing_enabled, type: :boolean)
    config.add(:secured_data_api_signing_key, type: :string)
