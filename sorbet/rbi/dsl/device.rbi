...
class Device
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Device` class because it declared `has_many :events`.
  ...
  module GeneratedAttributeMethods
    ...
    def cookie_uuid=(value); end

    sig { returns(T::Boolean) }
    def cookie_uuid?; end

    sig { returns(T.nilable(::String)) }
    def cookie_uuid_before_last_save; end

    sig { returns(T.untyped) }
    def cookie_uuid_before_type_cast; end

    sig { returns(T::Boolean) }
    def cookie_uuid_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def cookie_uuid_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def cookie_uuid_change_to_be_saved; end

    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def cookie_uuid_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def cookie_uuid_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def cookie_uuid_previous_change; end

    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def cookie_uuid_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def cookie_uuid_previously_was; end

    sig { returns(T.nilable(::String)) }
    def cookie_uuid_was; end

    sig { void }
    def cookie_uuid_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_cookie_uuid; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_cookie_uuid?; end
