  ...
  class AamvaStateMaintenanceWindow
    ...
    MAINTENANCE_WINDOWS = {
      'AL' => [
        ...
        Window.new(cron: '0 1 * * Mon#1', duration_minutes: 6 * 60),
      ],
      'CA' => [
        # Daily, 4:00 - 5:30 am. ET.
        Window.new(cron: '0 4 * * *', duration_minutes: 90),
        # Monday, 1:00 - 1:45 am. ET
        Window.new(cron: '0 1 * * Mon', duration_minutes: 45),
        # Monday, 1:00 - 4:30 am. ET on 1st and 3rd Monday of month.
        Window.new(cron: '0 1 * * Mon#1', duration_minutes: 3.5 * 60),
        Window.new(cron: '0 1 * * Mon#3', duration_minutes: 3.5 * 60),
      ],
      'CO' => [
        # 02:00 - 08:00 AM ET on the first Tuesday of every month.
        Window.new(cron: '0 2 * * Tue#1', duration_minutes: 6 * 60),
      ],
      'CT' => [
        # Daily, 3:00 am. to 4:00 am. ET.
        Window.new(cron: '0 3 * * *', duration_minutes: 1),
        # Sunday 5:00 am. to 7:00 am. ET
        Window.new(cron: '0 6 * * Sun', duration_minutes: 2 * 60),
        # second Sunday of month 4:00 am. to 8:00 am. ET
        Window.new(cron: '0 4 * * Sun#2', duration_minutes: 4 * 60),
      ],
      'DC' => [
        # Daily, Midnight to 6 am. ET.
        Window.new(cron: '0 0 * * *', duration_minutes: 6 * 60),
      ],
      'DE' => [
        # Daily, Midnight to 5 am. ET.
        Window.new(cron: '0 0 * * *', duration_minutes: 5 * 60),
      ],
      'FL' => [
        # Sunday 7:00 am. to 12:00 pm. ET
        Window.new(cron: '0 7 * * Sun', duration_minutes: 5 * 60),
      ],
      'GA' => [
        # Daily, 5:00 am. to 6:00 am. ET.
        Window.new(cron: '0 5 * * *', duration_minutes: 60),
      ],
      'IA' => [
        # "Daily, normally at 4:45 am. to 5:15 am ET."
        Window.new(cron: '45 4 * * *', duration_minutes: 30),
      ...
      'ID' => [
        ...
        Window.new(cron: '0 21 * * Wed', duration_minutes: 3 * 60),
      ],
      'IL' => [
        # Daily, 2:30 am. to 5:00 am. ET.
        Window.new(cron: '30 2 * * *', duration_minutes: 2.5 * 60),
      ],
      'IN' => [
        # Sunday 5:00 am. to 10:00 am. ET.
        Window.new(cron: '0 5 * * Sun', duration_minutes: 5 * 60),
      ],
      'KS' => [
        # Sunday: 7:00 am. to 1:00 pm. ET
        Window.new(cron: '0 7 * * Sun', duration_minutes: 6 * 60),
      ],
      'KY' => [
        # Daily maintenance from 2:35 am. to 6:40 am. ET
        Window.new(cron: '35 2 * * *', duration_minutes: 245),
        # "Monthly on Sunday, midnight to 10:00 am ET."
        # (Okay, but _which_ Sunday?)
      ],
      'MA' => [
        # Daily 3:00 am. to 4:00 am. ET.
        Window.new(cron: '0 3 * * *', duration_minutes: 60),
        # Saturday 10:00 pm. to Sunday 10:00 am
        Window.new(cron: '0 22 * * Sat', duration_minutes: 12 * 60),
        # Sunday 2:00 am to 5:00 am ET
        Window.new(cron: '0 2 * * Sun', duration_minutes: 3 * 60),
        # First Friday of each month: 12 to 6 am. ET.
        Window.new(cron: '0 0 * * Fri#1', duration_minutes: 6 * 60),
      ],
      'MD' => [
        # Sunday maintenance may occur from 6 am. to 10 am. ET.
        Window.new(cron: '0 6 * * Sun', duration_minutes: 4 * 60),
      ],
      'MI' => [
        # Daily maintenance from 9 pm. to 9:30 pm. ET.
        Window.new(cron: '0 21 * * *', duration_minutes: 30),
      ],
      'MO' => [
        # Daily maintenance from 2 am. to 4:30 am. ...
        Window.new(cron: '0 2 * * *', duration_minutes: 2.5 * 60),
        # ... from 6:30 am to 6:45 am ...
        Window.new(cron: '30 6 * * *', duration_minutes: 15),
        # ... and 8:30 am. to 8:35 am ET.
        Window.new(cron: '30 8 * * *', duration_minutes: 5),
      ],
      'MT' => [
        # Third Saturday of odd numbered months from 12:00 am to 6:00 am ET
        Window.new(cron: '0 2 * /2 Sat#3', duration_minutes: 6 * 60),
      ],
      'NC' => [
        # Daily, Midnight to 7:00 am. ET.
        Window.new(cron: '0 0 * * *', duration_minutes: 7 * 60),
      ],
      'ND' => [
        # Wednesday around 7:30 pm to 7:35 pm ET
        Window.new(cron: '30 19 * * Wed', duration_minutes: 5),
        # 3rd Sunday of month, 5 minutes anytime between midnight and noon.
      ],
      'NM' => [
        # Sundays 8:00 am. to noon ET.
        Window.new(cron: '0 8 * * Sun', duration_minutes: 4 * 60),
      ],
      'NV' => [
        # Tuesdays to Sundays: 2:00 am. to 3:15 am. ET
        Window.new(cron: '0 2 * * Tue-Sun', duration_minutes: 1.25 * 60),
      ],
      'NY' => [
        # Sunday maintenance 8 pm. to 9 pm. ET.
        Window.new(cron: '0 20 * * Sun', duration_minutes: 60),
      ],
      'OH' => [
        # Daily 4:00 am. to 4:30 am. ET
        Window.new(cron: '0 4 * * *', duration_minutes: 30),
      ],
      'OR' => [
        # Sunday 7:30 am. to 9:00 am. ET.
        Window.new(cron: '30 7 * * Sun', duration_minutes: 1.5 * 60),
      ],
      'PA' => [
        # Sunday 5:00 am. to 7:00 am. ET.
        Window.new(cron: '0 5 * * Sun', duration_minutes: 2 * 60),
      ],
      'RI' => [
        # Either 3rd or 4th Sunday of each month, 7:30 am. to 10:00 am. ET.
        Window.new(cron: '30 7 * * Sun#3', duration_minutes: 2.5 * 60),
        Window.new(cron: '30 7 * * Sun#4', duration_minutes: 2.5 * 60),
      ],
      'SC' => [
        # Sunday 6:00 pm. to 10:00 pm. ET.
        Window.new(cron: '0 18 * * Sun', duration_minutes: 4 * 60),
      ],
      'TN' => [
        # Last Sunday of every month from 11:00 pm Sunday to 2:00 am. Monday ET
        Window.new(cron: '0 23 * * Sun#last', duration_minutes: 3 * 60),
      ],
      'TX' => [
        # Saturday 9:00 pm. to Sunday 7:00 am. ET.
        Window.new(cron: '0 21 * * Sat', duration_minutes: 10 * 60),
      ],
      'UT' => [
        # 3rd Sunday of every month 1:00 am. to 9:00 am. ET
        Window.new(cron: '0 1 * * Sun#3', duration_minutes: 8 * 60),
      ],
      'VA' => [
        # Daily 5:00 am. to 5:30 am. ET
        Window.new(cron: '0 5 * * *', duration_minutes: 30),
        # Sunday morning maintenance 3:00 am. to 5 am. ET.
        Window.new(cron: '0 3 * * Sun', duration_minutes: 2 * 60),
      ...
      'WA' => [
        ...
        Window.new(cron: '45 21 * * Sat', duration_minutes: 10.5 * 60),
      ],
      'WI' => [
        # Downtime on Tuesday – Saturday typically between 3 – 4 am ET.
        Window.new(cron: '0 3 * * Tue-Sat', duration_minutes: 60),
        # Downtime on Sunday from 6 – 10 am. ET.
        Window.new(cron: '0 6 * * Sun', duration_minutes: 4 * 60),
      ],
      'WV' => [
        # Sunday 6:00 am. to 6:20 am. ET
        Window.new(cron: '0 6 * * Sun', duration_minutes: 20),
      ],
      'WY' => [
        # Daily, 2 am. to 5 am. ET.
        Window.new(cron: '0 2 * * *', duration_minutes: 3 * 60),
      ],
    }.freeze
