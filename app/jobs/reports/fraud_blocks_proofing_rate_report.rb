...
# TODO: UPDATE FOR FRAUD_BLOCKS TERMINOLOGY
require 'csv'
require 'reporting/fraud_blocks_proofing_rate_report'

module Reports
  class FraudBlocksProofingRateReport < BaseReport
    REPORT_NAME = 'fraud-blocks-proofing-rate-report'
    ...
    def perform(date = Time.zone.yesterday.end_of_day)
      ...
      ReportMailer.tables_report(
        ...
        subject: "Fraud Blocks Proofing Rate Report - #{report_date.to_date}",
        reports: reports,
        message: preamble,
    ...
    def reports
      @reports ||= fraud_blocks_proofing_rate_report.as_emailable_reports
    end
