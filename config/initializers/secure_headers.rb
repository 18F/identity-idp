SecureHeaders::Configuration.default do |config| # rubocop:disable Metrics/BlockLength
  ...
  default_csp_config = {
    ...
    font_src: ["'self'", 'data:', AppConfig.env.asset_host.presence],
    img_src: [
      "'self'",
      'data:',
      'login.gov',
      AppConfig.env.asset_host.presence,
    ...
    style_src: ["'self'", AppConfig.env.asset_host.presence],
    base_uri: ["'self'"],
  }
...
Rails.application.configure do |config|
  ...
  available_locales = AppConfig.env.available_locales
