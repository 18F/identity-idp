class IdentityConfig
  ...
  def self.build_store(config_map)
    ...
    config.add(:newrelic_account_id, type: :string)
    config.add(:newrelic_browser_agent_id, type: :string)
    config.add(:newrelic_browser_app_id, type: :string)
    config.add(:newrelic_browser_license_key, type: :string)
    config.add(:newrelic_browser_trust_key, type: :string)
