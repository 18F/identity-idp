...
module Saml
  module Idp
    module Constants
      ...
      ISSUERS_WITH_EMAIL_NAMEID_FORMAT = AppConfig.env.issuers_with_email_nameid_format.freeze
      ...
      VALID_AUTHN_CONTEXTS = AppConfig.env.valid_authn_contexts.dup.freeze
