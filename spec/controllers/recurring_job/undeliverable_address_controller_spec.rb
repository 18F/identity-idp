...
describe RecurringJob::UndeliverableAddressController do
  describe '#create' do
    ...
    it_behaves_like 'a recurring job controller', Identity::Hostdata.settings.usps_download_token

    context 'with a valid token' do
      before do
        request.headers['X-API-AUTH-TOKEN'] = Identity::Hostdata.settings.usps_download_token
      end
