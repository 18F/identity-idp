  ...
  class RedisClient
    def write_event(event_key:, jwe:, timestamp:, issuer:)
      ...
      REDIS_SECURED_DATA_API_POOL.with do |client|
        ...
        client.expire(key, IdentityConfig.store.secured_data_api_event_ttl_seconds)
      end
    end
