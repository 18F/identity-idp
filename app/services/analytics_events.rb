...
module AnalyticsEvents
  ...
  # User visits webauth platform upsell after password setup
  def webauthn_platform_signup_setup_visited_ab_test
    track_event(:webauthn_platform_signup_setup_visited_ab_test)
  end
