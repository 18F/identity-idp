...
module IdentityConfig
  ...
  BUILDER = proc do |config|
    ...
    config.add(:idv_socure_docv_flow_license_only, type: :string)
    config.add(:idv_socure_docv_flow_license_w_selfie, type: :string)
    ...
    config.add(:socure_docv_selfie_enabled, type: :boolean)
