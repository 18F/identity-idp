...
feature 'Analytics Regression', js: true do
  ...
  let(:happy_path_events) do
    {
      'IdV: intro visited' => {},
      'IdV: doc auth welcome visited' => { flow_path: 'standard', step: 'welcome', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth welcome submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement visited' => { flow_path: 'standard', step: 'agreement', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth upload visited' => { flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth upload submitted' => { success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth document_capture visited' => { flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      ...
      'Frontend: IdV: document capture async upload encryption' => hash_including('success' => true, 'flow_path' => 'standard'),
      ...
      'Frontend: IdV: document capture async upload submitted' => hash_including('success' => true, 'trace_id' => nil, 'status_code' => 200, 'flow_path' => 'standard'),
      ...
      'IdV: doc auth verify_document_status submitted' => { success: true, errors: {}, remaining_attempts: 3, flow_path: 'standard', step: 'verify_document_status', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false, doc_auth_result: 'Passed', attention_with_barcode: false, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth document_capture submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn visited' => { flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify visited' => { flow_path: 'standard', step: 'verify', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'verify', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify_wait visited' => { flow_path: 'standard', step: 'verify_wait', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false, native_camera_a_b_testing_enabled: false, native_camera_only: false },
  ...
  let(:gpo_path_events) do
    {
      ...
      'IdV: doc auth image upload form submitted' => { success: true, errors: {}, attempts: nil, remaining_attempts: 3, user_id: nil, flow_path: 'standard' },
      'IdV: doc auth image upload vendor pii validation' => { success: true, errors: {}, user_id: nil, remaining_attempts: 3, flow_path: 'standard', attention_with_barcode: false },
      'IdV: doc auth verify_document_status submitted' => { success: true, errors: {}, remaining_attempts: 3, flow_path: 'standard', step: 'verify_document_status', step_count: 1, attention_with_barcode: false, analytics_id: 'Doc Auth', irs_reproofing: false, doc_auth_result: 'Passed', native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth document_capture submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn visited' => { flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth ssn submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'ssn', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth verify visited' => { flow_path: 'standard', step: 'verify', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
  ...
  let(:in_person_path_events) do
    {
      ...
      'IdV: doc auth welcome submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'welcome', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement visited' => { flow_path: 'standard', step: 'agreement', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth agreement submitted' => { success: true, errors: {}, flow_path: 'standard', step: 'agreement', step_count: 1, analytics_id: 'Doc Auth', irs_reproofing: false, native_camera_a_b_testing_enabled: false, native_camera_only: false },
      'IdV: doc auth upload visited' => { flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth upload submitted' => { success: true, errors: {}, destination: :document_capture, flow_path: 'standard', step: 'upload', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'IdV: doc auth document_capture visited' => { flow_path: 'standard', step: 'document_capture', step_count: 1, native_camera_a_b_testing_enabled: false, native_camera_only: false, analytics_id: 'Doc Auth', irs_reproofing: false },
      'Frontend: IdV: front image added' => { 'width' => 284, 'height' => 38, 'mimeType' => 'image/png', 'source' => 'upload', 'size' => 3694, 'attempt' => 1, 'flow_path' => 'standard', 'acuant_sdk_upgrade_a_b_testing_enabled' => 'false', 'use_newer_sdk' => anything, 'acuant_version' => anything },
      ...
      'IdV: phone confirmation form' => { success: true, errors: {}, phone_type: :mobile, types: [:fixed_or_mobile], carrier: 'Test Mobile Carrier', country_code: 'US', area_code: '202', proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis' }, otp_delivery_preference: 'sms' },
      ...
      'IdV: phone confirmation otp submitted' => { success: true, code_expired: false, code_matches: true, second_factor_attempts_count: 0, second_factor_locked_at: nil, proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }, errors: {} },
      'IdV: review info visited' => { proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }, address_verification_method: 'phone' },
      ...
      'IdV: personal key visited' => { proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }, address_verification_method: 'phone' },
      ...
      'IdV: personal key submitted' => { proofing_components: { document_check: 'usps', document_type: 'state_id', source_check: 'aamva', resolution_check: 'lexis_nexis', address_check: 'lexis_nexis_address' }, address_verification_method: 'phone' },
