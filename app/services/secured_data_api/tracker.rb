...
module SecuredDataApi
  class Tracker
    ...
    def track_event(event_type, metadata = {})
      ...
      jwe = event.to_jwe(
        issuer: sp.issuer,
        public_key: sp.secured_data_public_key,
      )
    ...
    def enabled?
      IdentityConfig.store.secured_data_api_enabled && @enabled_for_session
    end

    def redis_client
      @redis_client ||= SecuredDataApi::RedisClient.new
    end
  end
end
