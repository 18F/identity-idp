class Navigation
  ...
  def navigation_items
    [
      NavItem.new(
        I18n.t('account.navigation.your_account'),
        account_path,
        [
      ...
      NavItem.new(
        ...
        [
          ...
          NavItem.new(I18n.t('account.navigation.get_backup_codes'), backup_codes_path),
        ],
      ),
      NavItem.new(
      ...
      NavItem.new(
        I18n.t('account.navigation.history'),
        account_history_path,
        [NavItem.new(I18n.t('account.navigation.forget_browsers'), forget_all_browsers_path)],
      ),
