...
function webauthn() {
  ...
  const webauthnInProgressContainer = document.getElementById(
    'webauthn-auth-in-progress',
  );
  const webauthnSuccessContainer = document.getElementById(
    'webauthn-auth-successful',
  );
  ...
  WebAuthn.verifyWebauthnDevice({
    ...
    document.getElementById('authenticator_data').value =
