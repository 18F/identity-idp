    ...
    [
      ...
      NavItem.new(I18n.t('account.navigation.two_factor_authentication'),
                  account_two_factor_authentication_path, [
                    ...
                    NavItem.new(I18n.t('account.navigation.add_authentication_apps'), authenticator_setup_url),
                    ...
                    NavItem.new(I18n.t('account.navigation.get_backup_codes'), backup_codes_path(user)),
                  ]),
